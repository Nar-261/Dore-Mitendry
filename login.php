...
<body>
  <div class="auth-card">
    <h1>Connexion</h1>
    <p class="muted">Accédez à votre espace d'apprentissage musical.</p>
    ...
    <p class="muted" style="margin-top:12px;">Pas encore de compte ? <a href="register.php">Créer un compte</a></p>
  </div>
</body>
</html>
